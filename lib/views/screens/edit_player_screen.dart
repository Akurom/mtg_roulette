...
import 'package:mtg_roulette/commands/player/edit_player_command.dart';
                      ...
                      (index) {
                        return InkWell(
                          child: Card(
                              ...
                              child: (AppModel().colorPalette[index].value == _currentColor.value)
                                  ? Icon(Icons.check)
                                  : null),
                          onTap: () {
                            setState(() {
                      ...
                      (index) {
                        return InkWell(
                          child: Container(
                              ...
                              child: (AppModel().watermarks[index] == _currentWatermark)
                                  ? Icon(
                                      Icons.check,
                                      color: Colors.white,
                                    )
